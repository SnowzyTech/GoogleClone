    ...
    <div className='flex flex-col items-center justify-center h-screen'>
     ...
     <header className='flex w-full p-5 justify-between text-sm text-gray-700'>
      ...
      <form className='flex flex-col items-center mt-44 flex-grow w-4/5'>
        <Image src='https://www.google.co.uk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png' height={100} width={300} alt=""/>

        <div className='flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md rounded-full border border-gray-200 px-5 py-3
        ...
        <div className='flex flex-col w-1/2 space-y-2 justify-center mt-4 sm:space-y-0 sm:flex-row sm:space-x-4'>
          ...
          <button onClick={search} className='btn'>I&apos;m Felling Lucky</button>
        </div>
      </form>
